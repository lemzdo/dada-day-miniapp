...
const TODAY_RESTORE_SNAPSHOT_BUSINESS_KEY = 'today:outfitReturnSnapshot:recommendation-copy-contract-v4';
const TODAY_SCENE_SNAPSHOT_BUSINESS_PREFIX = 'today:sceneSnapshot:recommendation-copy-contract-v4';
