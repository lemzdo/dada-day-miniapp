...
test('V2 batch core only contains the batch contract fields', () => {
  const result = projectBatchCoreV2({ batchId: 'batch-1', commitToken: 'commit-1', contentHash: 'hash-1', scene: '居家', date: '2026-08-20', timeOfDay: 'all_day', weather: { temp: 28 }, inputIdentityHash: 'input-1', generatedAt: '2026-08-20T00:00:00.000Z', order: Array.from({ length: 8 }, (_, index) => `key-${index}`), scores: { forbidden: true } });
